...
pub struct ProbeSystem {
    ...
    pub arch: String,
    /// The RamSleuth version that produced this report (e.g. "2.4.5").
...
mod tests {
    ...
    fn render_probe_report_md_has_all_sections_and_key_values() {
        ...
        assert!(
            md.contains(
                "> **Intel(R) Core(TM) i7-11700K CPU @ 3.60GHz** — RocketLake on Linux / Arch (kernel 6.6.0-1-cachyos), RamSleuth v2.4.5"
            ),
            "{md}"
        );
        ...
        assert!(md.contains("| RamSleuth Version | 2.4.5 |"), "{md}");
        ...
        assert!(
            md.contains(
                "_This report was auto-generated by RamSleuth v2.4.5. It contains no personal information (no username, hostname, IP, MAC, or serial numbers)._"
            ),
            "{md}"
        );
    }
