...
- **Status:** install path fully fixed (staging + dkms.conf MAKE + build/install version arguments); the operator's re-run on the real kernel is the ground-truth verification.
