...
@@@ ACTIVE_WORKERS @@@
- [ACTIVE] ID: P5-11 | AGENT: general (Implementation Agent) | BRANCH: branch/chunk-p5-11-dkms | FILES: [scripts/install-ryzen-smu-dkms.sh] — fix install script: stage source to /usr/src before dkms add
